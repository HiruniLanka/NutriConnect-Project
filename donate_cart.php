...
<body>
   ...
   <section class="shopping-cart">
      ...
      <div class="box-container">
         ...
         if (mysqli_num_rows($select_cart) > 0) {
            while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
               ?>
               <div class="box">
                  <a href="donate_cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times"
      ...
      <div style="margin-top: 2rem; text-align:center;">
         <a href="donate_cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>"
      ...
      <div class="cart-total">
         ...
         <div class="flex">
            ...
            <a href="donate_checkout.php" class="btn <?php echo ($grand_total > 1) ? '' : 'disabled'; ?>">Proceed to
               Checkout</a>
         </div>
      </div>
