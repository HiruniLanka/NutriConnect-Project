...
<div class="headers">
        ...
        <nav class="navbar">
            <a href="admin_menu_orders.php">Menu Orders</a>
        </nav>
...
<section class="add-products">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="submit" value="add menu item" name="add_product" class="btn">
   </form>
...
<section class="show-products">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="admin_menu.php?update=<?php echo $fetch_products['id']; ?>" class="option-btn">update</a>
         <a href="admin_menu.php?delete=<?php echo $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">delete</a>
      </div>
      <?php
         }
      }else{
